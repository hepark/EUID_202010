...
<br />
<details start>
<summary>AppNavigation.jsx</summary>
...
>🍊 `Tab`키의 keyCode가 9인 건 어떻게 알 수 있을까? 자바스크립트 이벤트 keyCode 정보는 여기로 👉[http://keycode.info/](http://keycode.info/)
